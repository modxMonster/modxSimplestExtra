...
class Doodles {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        // $basePath = dirname(MODX_BASE_PATH) . '/html/doodlesMine/core/components/doodles/';
        // $assetsUrl = dirname(MODX_BASE_PATH) . '/html/doodlesMine/assets/components/doodles/';
        // $basePath = 'https://192.168.0.104/doodlesMine/core/components/doodles/';
        //$assetsUrl = 'https://192.168.0.104/doodlesMine/assets/components/doodles/';
        ...
        $this->config = array_merge(array(
            ...
            'templatesPath' => $basePath.'templates/default/',
